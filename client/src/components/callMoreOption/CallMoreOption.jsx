import "./CallMoreOption.css";

const CallMoreOption = ({ top, left, ref }) => {
  return (
    <div className="call-more-options" ref={ref} style={{ top, left }}>
      <div className="call-more-option">
        <svg
