...
const HomeDesktop = ({
  ...
  const [isContinuesBtnLoading, setIsContinuesBtnLoading] = useState(false);
                ...
                >
                  ...
                  <div className="searched-continued-container">
                    <button
                      ...
                      onClick={() => {
                        setIsContinuesBtnLoading(true);
                        // delay
                        setTimeout(() => {
                          setIsContinuesBtnLoading(false);
                          navigate(`/before-call/${selectedUser.id}`);
                        }, 2000);
                      }}
                    >
                      Continue{" "}
                      {isContinuesBtnLoading ? (
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          height="24px"
                          viewBox="0 -960 960 960"
